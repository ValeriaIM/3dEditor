...
Она умеет создавать точки, прямые и плоскости с помощью точек.
...
меню создания основных элементов: точка, линия, плоскость
(Их также можно быстро выбрать, нажав `1`, `2`, `3` соответственно)
...
стобы создать плоскость: выберите ее из меню, нажмите поочередно на 3 разных или более точек,
